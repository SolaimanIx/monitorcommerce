...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $monthlyDatas = DB::select("SELECT M.id As MonthNo, M.name As MonthName,
            ...
            sum(if(status='delivered',total,0)) As TotalDeliveredAmount,
            sum(if(status='canceled',total,0)) As TotalCanceledAmount
            From orders WHERE YEAR(created_at)=YEAR(NOW()) GROUP BY YEAR(created_at), MONTH(created_at) , DATE_FORMAT(created_at, '%b') ) D On D.MonthNo=M.id");
        ...
        return view('admin.dashboard', compact('orders', 'dashboardDatas', 'monthlyDatas', 'AmountM', 'OrderedAmountM', 'DeliveredAmountM', 'CanceledAmountM', 'TotalAmount', 'TotalOrderedAmount', 'TotalDeliveredAmount', 'TotalCanceledAmount'));
    }
