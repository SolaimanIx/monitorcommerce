                    ...
                    <div class="row mt-5">
                        <div class="col-md-6">
                            <div class="form-floating my-3">
                                ...
                                @error('name')('name') <span class="text-danger">{{$message}}</span> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating my-3">
                            ...
                            <table class="checkout-totals">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">${{Session::get('discount')['subtotal_after_discount']}}</td>
                                    </tr>
                                    @endif
                                    <tr>
                                        <th>SHIPPING</th>
                                    ...
                                    <tr>
                                        <th>VAT</th>
                                        <td align="right">${{Session::get('discount')['tax_after_discount']}}</td>
                                    </tr>
                                    <tr>
                                        <th>TOTAL</th>
                                        <td align="right">${{Session::get('discount')['total_after_discount']}}</td>
                                    </tr>
                                    @else
                                    <tr>
                                        <th>VAT</th>
