    ...
    <section class="products-grid container">
      ...
      <div class="row">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product-card product-card-style3 mb-3 mb-md-4 mb-xxl-5">
            <div class="pc_img-wrapper">
              <a href="{{ route('shop.product.details', ['product_slug' => $fproduct->slug]) }}">
                <img loading="lazy" src="{{ asset('uploads/products') }}/{{$fproduct->image}}" width="330" height="400"
                  alt="{{$fproduct->name}}" class="pc_img" />
              </a>
            </div>
            <div class="pc_info position-relative">
              <h6 class="pc_title"><a href="{{ route('shop.product.details', ['product_slug' => $fproduct->slug]) }}">{{$fproduct->name}}</a></h6>
